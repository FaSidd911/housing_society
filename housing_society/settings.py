...
SECRET_KEY = 'django-insecure-#yrww*$=opc$2kw7e=#=aiwgj5n4-t4)maf6^3s41w-_mbd!9z'
...
ROOT_URLCONF = 'housing_society.urls'
...
WSGI_APPLICATION = 'housing_society.wsgi.application'
